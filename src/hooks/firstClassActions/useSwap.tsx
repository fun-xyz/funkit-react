import { EnvOption, ExecutionReceipt, Operation, SwapParam } from '@fun-xyz/core'
...
export const useSwap = (build: ITransferParams) => {
  ...
  const swap = useCallback(
    async (auth?: Auth[]) => {
      ...
      try {
        ...
        const UserOp = await wallet.swap(firstSigner, userId, build.params, build.txOptions)
