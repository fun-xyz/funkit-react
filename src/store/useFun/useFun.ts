...
export interface useFunStoreInterface extends ConnectorStoreInterface, ChainStoreInterface, ConfigureStoreInterface {
    index: number
...
export const createUseFun = (hookBuildParams: createUseFunInterface) => {
    console.log("createUseFun", JSON.stringify(hookBuildParams.connectors))
    return create(
